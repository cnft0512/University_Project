...
<body>
   ...
   <button type="button" id="timeTableForListCollapse"
      class="btn btn-primary">시간표 확인</button>
            ...
            <c:forEach var="lec_list" items="${list}" varStatus="vs">
               <div class="lecture_list_body_row">
                  <c:if
                     ...
                     <c:choose>
                        <c:when
                           test="${lec_list.semester ne '2학기' && serverTime.getMonth() eq 'FEBRUARY'}">
                           <%@ include file="../lecture/list.jsp"%>
                           <!-- 1학기 -->
                        </c:when>
                        <c:when
                           test="${lec_list.semester ne '1학기' && serverTime.getMonth() eq 'AUGUST'}">
                           <%@ include file="../lecture/list.jsp"%>
                           <!-- 2학기 -->
                        </c:when>
                     </c:choose>
